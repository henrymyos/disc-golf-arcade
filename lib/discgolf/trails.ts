...
export const TRAILS: Trail[] = [
  ...
  // Solid colors
  { key: "teal", name: "Teal", desc: "Cool mint streak", price: 1400, kind: "solid", colors: ["#36D7B7"] },
  { key: "gold", name: "Gold", desc: "Warm gold streak", price: 1400, kind: "solid", colors: ["#f5d24a"] },
  { key: "crimson", name: "Crimson", desc: "Bold red streak", price: 1400, kind: "solid", colors: ["#e23b3b"] },
  { key: "violet", name: "Violet", desc: "Rich purple streak", price: 1750, kind: "solid", colors: ["#b85cd6"] },
  { key: "sky", name: "Sky", desc: "Bright blue streak", price: 1750, kind: "solid", colors: ["#5fb0e8"] },
  // Effects
  { key: "aurora", name: "Aurora", desc: "Teal-to-violet gradient", price: 4200, kind: "gradient", colors: ["#36D7B7", "#b85cd6"] },
  { key: "ice", name: "Ice", desc: "Frosty blue glow", price: 5000, kind: "ice", colors: ["#bdecff", "#5fb0e8", "#ffffff"] },
  { key: "fire", name: "Fire", desc: "Flickering flames", price: 5500, kind: "fire", colors: ["#e23b3b", "#e0923b", "#f5d24a"] },
  { key: "neon", name: "Neon", desc: "Glowing electric line", price: 6300, kind: "neon", colors: ["#36ffe0"] },
  { key: "shadow", name: "Shadow", desc: "Dark smoky wake", price: 6300, kind: "shadow", colors: ["#1a1d23", "#5b4b8a"] },
  { key: "sparkle", name: "Sparkle", desc: "Twinkling stardust", price: 8500, kind: "sparkle", colors: ["#fff7cf", "#f5d24a"] },
  { key: "rainbow", name: "Rainbow", desc: "Full-spectrum streak", price: 10500, kind: "rainbow", colors: [] },
];
