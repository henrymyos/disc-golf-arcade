...
export const DISC_SKINS: DiscSkin[] = [
  ...
  { key: "gold", name: "Gold", desc: "Warm gold body", price: 1400, body: "#f5d24a", kind: "solid" },
  { key: "sky", name: "Sky", desc: "Bright blue body", price: 1400, body: "#7cc5f0", kind: "solid" },
  { key: "coral", name: "Coral", desc: "Sunset orange body", price: 1400, body: "#f08a6b", kind: "solid" },
  { key: "mint", name: "Mint", desc: "Cool mint body", price: 1750, body: "#7fe6c8", kind: "solid" },
  { key: "shadow", name: "Shadow", desc: "Stealthy dark body", price: 3500, body: "#3a3f4a", kind: "solid" },
  { key: "neon", name: "Neon", desc: "Glowing electric disc", price: 5000, body: "#36ffe0", kind: "glow" },
  { key: "ember", name: "Ember", desc: "Glowing molten disc", price: 5000, body: "#ff7a3b", kind: "glow" },
  { key: "chrome", name: "Chrome", desc: "Shiny metallic finish", price: 5500, body: "#d7dde6", kind: "chrome" },
  { key: "galaxy", name: "Galaxy", desc: "Deep-space swirl", price: 7000, body: "#6a4bd6", kind: "galaxy" },
];
...
export const BASKET_SKINS: BasketSkin[] = [
  ...
  { key: "gold", name: "Gold", desc: "Gleaming gold basket", price: 2000, pole: "#caa53a", base: "#a9871f", band: "#f0d873", chains: "#dcc05a" },
  { key: "crimson", name: "Crimson", desc: "Bold red basket", price: 2000, pole: "#c14b4b", base: "#9a3434", band: "#f08a8a", chains: "#d76a6a" },
  { key: "emerald", name: "Emerald", desc: "Lush green basket", price: 2500, pole: "#3ca06a", base: "#2a7d50", band: "#74d6a0", chains: "#5ac088" },
  { key: "onyx", name: "Onyx", desc: "Matte black basket", price: 2800, pole: "#3a3f48", base: "#272b32", band: "#5a616c", chains: "#474d56" },
  { key: "neon", name: "Neon", desc: "Glowing cyber basket", price: 5000, pole: "#2bd6c4", base: "#1f9e90", band: "#7cffff", chains: "#36ffe0" },
];
...
export const AIM_STYLES: AimStyle[] = [
  ...
  { key: "teal", name: "Teal", desc: "Mint aim line", price: 1000, color: "#36D7B7" },
  { key: "gold", name: "Gold", desc: "Gold aim line", price: 1000, color: "#f5d24a" },
  { key: "crimson", name: "Crimson", desc: "Red aim line", price: 1000, color: "#e23b3b" },
  { key: "violet", name: "Violet", desc: "Purple aim line", price: 1400, color: "#c07ce0" },
  { key: "dashed", name: "Dashed", desc: "Dotted white line", price: 2000, color: "#ffffff", dash: [4, 4] },
  { key: "neon", name: "Neon", desc: "Glowing aim line", price: 3500, color: "#36ffe0", glow: true },
];
...
export const CELEBRATIONS: Celebration[] = [
  ...
  { key: "bubbles", name: "Bubbles", desc: "Floaty blue bubbles", price: 2500, colors: ["#bdecff", "#5fb0e8", "#ffffff"], count: 40, speed: 1.6, grav: -0.01, life: 60 },
  { key: "confetti", name: "Party", desc: "A big rainbow confetti shower", price: 3000, colors: ["#e23b3b", "#f5a623", "#f5d24a", "#36D7B7", "#5fb0e8", "#b85cd6"], count: 64, speed: 2.1, grav: 0.03, life: 66 },
  { key: "stars", name: "Stars", desc: "A golden starburst", price: 3500, colors: ["#fff7cf", "#f5d24a", "#ffe9a0"], count: 40, speed: 2.3, grav: 0.02, life: 52 },
  { key: "inferno", name: "Inferno", desc: "Erupting flames", price: 4200, colors: ["#e23b3b", "#e0923b", "#f5d24a"], count: 52, speed: 2.6, grav: -0.005, life: 46, bursts: 2 },
  { key: "fireworks", name: "Fireworks", desc: "Multiple booming pops", price: 5500, colors: ["#ff4d4d", "#f5d24a", "#36D7B7", "#5fb0e8", "#ffffff"], count: 24, speed: 2.9, grav: 0.04, life: 40, bursts: 4 },
  { key: "rainbow", name: "Rainbow", desc: "A full-spectrum explosion", price: 7000, colors: ["#ff4d4d", "#f5a623", "#f5d24a", "#36D7B7", "#5fb0e8", "#b85cd6", "#ffffff"], count: 60, speed: 2.7, grav: 0.03, life: 56, bursts: 2 },
];
